...
const GMatic = () => {
    ...
    const GwrMaticcontractAddress ='0x3695f1F21c9280A08796E1aC36389B5146d15336';
    ...
    const { contract } = useContract( GwrMaticcontractAddress );
        ...
        <div className='justify-center items-center text-center bg-neutral-950 rounded-md py-5 '>
            ...
            className='py-2'>
             {transactionSuccessful ? (
                <Web3Button
                contractAddress={GwrMaticcontractAddress}
                action = {(contract) => {
                    contract.call(
                        'stake',
            ...
            action = {(contract) => {
                contract.call(
                    'approve',
                    [GwrMaticcontractAddress, ethers.utils.parseEther(gwrToStake)]
            )
            }}
            onError={(error) => alert('Something went wrong!')}
